...
{
    var _w = window,
    _b = document.body,//è¿”å›žhtml domä¸­çš„bodyèŠ‚ç‚¹ å³<body>
    _d = document.documentElement;//è¿”å›žhtml domä¸­çš„root èŠ‚ç‚¹ å³<html>
    ...
    Factory.prototype = {
        ...
        _onDraw: function ()
        {
            ...
            this.animateId = requestAnimationFrame(this._onDraw);
        },
